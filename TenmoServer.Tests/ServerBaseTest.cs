...
namespace TenmoServer.Tests
{
    ...
    public class ServerBaseTest
    {
        ...
        protected User testUserOne { get; set; }

        protected User testUserTwo { get; set; }
        ...
        public void Initialize()
        {
            ...
            testUserOne = AddUser("inttest1", "test1");
            testUserTwo = AddUser("inttest2", "test2");
        ...
        public User AddUser(string username, string password)
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    cmd.Parameters.AddWithValue("@startBalance", 1000.00M);
                    cmd.ExecuteNonQuery();
                }
            }
            catch (SqlException)
